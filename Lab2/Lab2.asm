...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$Lab2.c$67$1$12 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:67: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$Lab2.c$70$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:70: Sys_Init(); /* Initialize the C8051 board */
	lcall	_Sys_Init
	C$Lab2.c$71$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:71: Port_Init(); /* Configure P1.4 for analog input */
	lcall	_Port_Init
	C$Lab2.c$72$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:72: ADC_Init(); /* Initialize A/D conversion */
	lcall	_ADC_Init
	C$Lab2.c$73$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:73: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$Lab2.c$75$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:75: while (1)          // infinite loop 
00102$:
	C$Lab2.c$79$2$42 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:79: Set_outputs();
	lcall	_Set_outputs
	sjmp	00102$
	C$Lab2.c$88$1$41 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$Lab2.c$91$1$41 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:91: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$Lab2.c$94$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:94: P3MDOUT &= 0xC0; // set Port 3 input pins to push-pull mode (fill in the blank)
	anl	_P3MDOUT,#0xc0
	C$Lab2.c$95$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:95: P3MDOUT |= 0xC0; // set Port 3 output pins to open drain mode (fill in the blank)
	orl	_P3MDOUT,#0xc0
	C$Lab2.c$96$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:96: P3 |= ~0xC0; // set Port 3 input pins to high impedance state (fill in the blank)
	orl	_P3,#0x3f
	C$Lab2.c$99$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:99: P2MDOUT |= ~0xC0;  // set Port 2 output pins
	orl	_P2MDOUT,#0x3f
	C$Lab2.c$102$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:102: P1MDIN &= ~0x10; /* Set P1.4 for analog input */
	anl	_P1MDIN,#0xef
	C$Lab2.c$103$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:103: P1MDOUT &= ~0x10; /* Set P1.4 to open drain */
	anl	_P1MDOUT,#0xef
	C$Lab2.c$104$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:104: P1 |= 0x10; /* Send logic 1 to input pin P1.4 for impedance */
	orl	_P1,#0x10
	C$Lab2.c$105$1$44 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$Lab2.c$109$1$44 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:109: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$Lab2.c$111$1$46 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:111: IE |= 0x82;      // enable Timer0 Interrupt request (by masking)
	orl	_IE,#0x82
	C$Lab2.c$112$1$46 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$Lab2.c$116$1$46 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:116: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$Lab2.c$119$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:119: CKCON |= 0x08;  // Timer0 uses SYSCLK as source
	orl	_CKCON,#0x08
	C$Lab2.c$120$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:120: TMOD &= 0xF0;   // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$Lab2.c$121$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:121: TMOD |= 0x01;   // Timer0 in mode 1 
	orl	_TMOD,#0x01
	C$Lab2.c$122$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:122: TR0 = 0;        // Stop Timer0
	clr	_TR0
	C$Lab2.c$123$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:123: TMR0 = 0;       // Clear high & low byte of T0
	clr	a
	mov	((_TMR0 >> 0) & 0xFF),a
	mov	((_TMR0 >> 8) & 0xFF),a
	C$Lab2.c$125$1$48 ==.
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$Lab2.c$129$1$48 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:129: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$Lab2.c$133$1$50 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:133: Counts++;
	inc	_Counts
	clr	a
...
00103$:
	C$Lab2.c$134$1$50 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:134: debounceCount++;
	inc	_debounceCount
	clr	a
	cjne	a,_debounceCount,00104$
	inc	(_debounceCount + 1)
00104$:
	pop	psw
	pop	acc
	C$Lab2.c$135$1$50 ==.
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$Lab2.c$139$1$50 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:139: void ADC_Init(void)
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$Lab2.c$141$1$52 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:141: REF0CN = 0x03;  /* Set Vref to use internal reference voltage (2.4V) */
	mov	_REF0CN,#0x03
	C$Lab2.c$142$1$52 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:142: ADC1CN = 0x80;  /* Enable A/D converter (ADC1) */
	mov	_ADC1CN,#0x80
	C$Lab2.c$143$1$52 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:143: ADC1CF |= 0x01; /* Set A/D converter gain to 1 */
	orl	_ADC1CF,#0x01
	C$Lab2.c$144$1$52 ==.
	XG$ADC_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$read_AD_input$0$0 ==.
	C$Lab2.c$148$1$52 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:148: unsigned char read_AD_input(unsigned char n)
;	-----------------------------------------
...
_read_AD_input:
	mov	_AMX1SL,dpl
	C$Lab2.c$151$1$54 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:151: ADC1CN = ADC1CN & ~0x20; /* Clear the “Conversion Completed” flag */
	anl	_ADC1CN,#0xdf
	C$Lab2.c$152$1$54 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:152: ADC1CN = ADC1CN | 0x10; /* Initiate A/D conversion */
	orl	_ADC1CN,#0x10
	C$Lab2.c$153$1$54 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:153: while ((ADC1CN & 0x20) == 0x00); /* Wait for conversion to complete */
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$Lab2.c$154$1$54 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:154: return ADC1; /* Return digital value in ADC1 register */
	mov	dpl,_ADC1
	C$Lab2.c$155$1$54 ==.
...
;------------------------------------------------------------
	G$Debounce$0$0 ==.
	C$Lab2.c$158$1$54 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:158: void Debounce(void)
;	-----------------------------------------
;	 function Debounce
;	-----------------------------------------
_Debounce:
	C$Lab2.c$160$1$56 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:160: debounceCount = 0; //reset counter
	clr	a
	mov	_debounceCount,a
	mov	(_debounceCount + 1),a
	C$Lab2.c$161$1$56 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:161: while(debounceCount < 7); //wait 20 msec
00101$:
	clr	c
	mov	a,_debounceCount
	subb	a,#0x07
	mov	a,(_debounceCount + 1)
	subb	a,#0x00
	jc	00101$
	C$Lab2.c$162$1$56 ==.
	XG$Debounce$0$0 ==.
...
;------------------------------------------------------------
	G$random$0$0 ==.
	C$Lab2.c$165$1$56 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:165: unsigned char random(void)
;	-----------------------------------------
;	 function random
;	-----------------------------------------
_random:
	C$Lab2.c$167$1$58 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:167: return rand()%3;  // rand returns a random number between 0 and 32767.
	lcall	_rand
...
;------------------------------------------------------------
	G$mode3$0$0 ==.
	C$Lab2.c$178$1$58 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:178: void mode3(void)
;	-----------------------------------------
;	 function mode3
;	-----------------------------------------
_mode3:
	C$Lab2.c$180$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:180: printf("\rMode 3\n\r");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$Lab2.c$181$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:181: printf("Match pattern by adjusting potentiometer\n\r");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$Lab2.c$182$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:182: LED3 = 1;
	setb	_LED3
	C$Lab2.c$183$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:183: LED2 = 1;
	setb	_LED2
	C$Lab2.c$184$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:184: LED1 = 1;
	setb	_LED1
	C$Lab2.c$185$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:185: LED0 = 1;
	setb	_LED0
	C$Lab2.c$186$1$63 ==.
;	C:\Users\Tim\Documents\LITEC\Lab2\Lab2.c:186: while(PB0){
00101$:
	jb	_PB0,00101$
	C$Lab2.c$190$1$63 ==.
	XG$mode3$0$0 ==.
...
FLab2$__str_1$0$0 == .
___str_1:
	.ascii "Match pattern by adjusting potentiometer"
	.db 0x0a
	.db 0x0d
	.db 0x00
	.area XINIT   (CODE)
