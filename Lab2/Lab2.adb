...
S:LLab2.getchar$c$1$10({1}SC:U),R,0,0,[r7]
...
S:G$Set_outputs$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$rand$1$58({2}DF,SI:S),C,0,0
S:G$mode0$0$0({2}DF,SV:S),C,0,0
S:G$mode1$0$0({2}DF,SV:S),C,0,0
S:G$mode2$0$0({2}DF,SV:S),C,0,0
S:FLab2$__str_0$0$0({10}DA10d,SC:S),D,0,0
S:FLab2$__str_1$0$0({43}DA43d,SC:S),D,0,0
