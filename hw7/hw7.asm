...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw7.c$41$1$12 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:41: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw7.c$43$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:43: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw7.c$44$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:44: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw7.c$45$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:45: Port_Init();     //set up port 1.4
	lcall	_Port_Init
	C$hw7.c$46$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:46: ADC_Init();		 //Set up converter and set gain to 0.5
	lcall	_ADC_Init
	C$hw7.c$47$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:47: printf("Start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw7.c$48$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:48: while (1) 
00102$:
	C$hw7.c$50$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:50: printf("enter key to read A/D input \r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw7.c$51$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:51: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw7.c$55$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:55: AD_value = read_AD_input(4); //read the value
	mov	dpl,#0x04
	lcall	_read_AD_input
	C$hw7.c$56$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:56: millivolts = AD_value*2.4*1000.0/(256.0*0.5); //conversion line
	mov  _AD_value,dpl
	lcall	___uchar2fs
	mov	r4,dpl
	mov	r5,dph
	...
	lcall	___fs2uint
	mov	_millivolts,dpl
	mov	(_millivolts + 1),dph
	C$hw7.c$58$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:58: printf("AD_value: %d\r\n", AD_value);	// print statement as required by homework
	mov	r6,_AD_value
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	mov	sp,a
	C$hw7.c$59$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:59: printf("\rmillivolts: %d\n\r", millivolts);	// print statement as required by homework
	push	_millivolts
	push	(_millivolts + 1)
	mov	a,#___str_3
	push	acc
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$hw7.c$68$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:68: void ADC_Init(void)
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$hw7.c$70$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:70: REF0CN = 0x03;  /* Set Vref to use internal reference voltage (2.4V) */
	mov	_REF0CN,#0x03
	C$hw7.c$71$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:71: ADC1CN = 0x80;  /* Enable A/D converter (ADC1) */
	mov	_ADC1CN,#0x80
	C$hw7.c$72$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:72: ADC1CF &= ~0x03; /* Set A/D converter gain to 0.5 */
	anl	_ADC1CF,#0xfc
	C$hw7.c$74$1$34 ==.
	XG$ADC_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$read_AD_input$0$0 ==.
	C$hw7.c$78$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:78: unsigned char read_AD_input(unsigned char pin_number)
;	-----------------------------------------
...
_read_AD_input:
	mov	_AMX1SL,dpl
	C$hw7.c$81$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:81: ADC1CN &= ~0x20; /* Clear the “Conversion Completed” flag */
	anl	_ADC1CN,#0xdf
	C$hw7.c$82$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:82: ADC1CN |= 0x10; /* Initiate A/D conversion */
	orl	_ADC1CN,#0x10
	C$hw7.c$83$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:83: while ((ADC1CN & 0x20) == 0x00); /* Wait for conversion to complete */
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$hw7.c$84$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:84: return ADC1; /* Return digital value in ADC1 register */
	mov	dpl,_ADC1
	C$hw7.c$85$1$36 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$hw7.c$89$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:89: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$hw7.c$92$1$38 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:92: P1MDIN &= ~0x10; /* Set P1.4 for analog input */
	anl	_P1MDIN,#0xef
	C$hw7.c$93$1$38 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:93: P1MDOUT &= ~0x10; /* Set P1.4 to open drain */
	anl	_P1MDOUT,#0xef
	C$hw7.c$94$1$38 ==.
;	C:\Users\Tim\Documents\LITEC\hw7\hw7.c:94: P1 |= 0x10; /* Send logic 1 to input pin P1.4 for impedance */
	orl	_P1,#0x10
	C$hw7.c$95$1$38 ==.
	XG$Port_Init$0$0 ==.
	ret
