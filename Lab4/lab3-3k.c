...
unsigned int Counts;
//stering servo
__xdata unsigned int sPW_CENTER = 2655; //1.5ms
__xdata unsigned int sPW_MIN = 2005; //0.9ms
__xdata unsigned int sPW_MAX = 3305; //2.1ms
unsigned int sPW = 0;
//motor
__xdata unsigned int mPW_CENTER = 2765; //1.5ms
__xdata unsigned int mPW_MIN = 2027; //1.1ms
__xdata unsigned int mPW_MAX = 3502; //1.9ms
unsigned int mPW = 0;
