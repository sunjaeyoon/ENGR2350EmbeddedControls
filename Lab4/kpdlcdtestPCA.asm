...
_Data2::
	.ds 3
LkpdlcdtestPCA.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
LkpdlcdtestPCA.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
LkpdlcdtestPCA.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
LkpdlcdtestPCA.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
LkpdlcdtestPCA.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
LkpdlcdtestPCA.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
LkpdlcdtestPCA.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
LkpdlcdtestPCA.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
LkpdlcdtestPCA.i2c_read_data$num_bytes$1$107==.
...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
LkpdlcdtestPCA.aligned_alloc$size$1$26==.
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
LkpdlcdtestPCA.lcd_print$text$1$81==.
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$kpdlcdtestPCA.c$37$1$113 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$kpdlcdtestPCA.c$40$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:40: Sys_Init();     // System Initialization - MUST BE 1st EXECUTABLE STATEMENT
	lcall	_Sys_Init
	C$kpdlcdtestPCA.c$41$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:41: Port_Init();    // Initialize ports 2 and 3 - XBR0 set to 0x05, UART0 & SMB
	lcall	_Port_Init
	C$kpdlcdtestPCA.c$42$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:42: Interrupt_Init();   // You may want to change XBR0 to match your SMB wiring
	lcall	_Interrupt_Init
	C$kpdlcdtestPCA.c$43$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:43: PCA_Init();
	lcall	_PCA_Init
	C$kpdlcdtestPCA.c$44$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:44: SMB0_Init();
	lcall	_SMB0_Init
	C$kpdlcdtestPCA.c$45$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:45: putchar('\r');  // Dummy write to serial port
	mov	dpl,#0x0d
	lcall	_putchar
	C$kpdlcdtestPCA.c$46$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:46: printf("\nStart\r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$kpdlcdtestPCA.c$48$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:48: Counts = 0;
	clr	a
	mov	_Counts,a
	mov	(_Counts + 1),a
	C$kpdlcdtestPCA.c$49$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:49: while (Counts < 1); // Wait a long time (1s) for keypad & LCD to initialize
00101$:
	clr	c
	mov	a,_Counts
	subb	a,#0x01
	...
	subb	a,#0x00
	jc	00101$
	C$kpdlcdtestPCA.c$51$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:51: lcd_clear();
	lcall	_lcd_clear
	C$kpdlcdtestPCA.c$52$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:52: lcd_print("Calibration:\nHello world!\n012_345_678:\nabc def ghij");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$kpdlcdtestPCA.c$53$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:53: while (1)
00105$:
	C$kpdlcdtestPCA.c$55$2$123 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:55: keypad =  kpd_input(0);
	mov	dpl,#0x00
	lcall	_kpd_input
	mov	r6,dpl
	C$kpdlcdtestPCA.c$73$2$123 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:73: printf("\n\rYour key was: %c,  = Hex %X,  = Decimal %u", keypad, keypad, keypad);
	mov	r7,#0x00
	push	ar6
	push	ar7
	push	ar6
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$kpdlcdtestPCA.c$78$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:78: void Port_Init(void)	//0x05
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$kpdlcdtestPCA.c$80$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:80: XBR0 = 0x27;    // NOTE: Only UART0 & SMB enabled; SMB on P0.2 & P0.3
	mov	_XBR0,#0x27
	C$kpdlcdtestPCA.c$81$1$125 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$kpdlcdtestPCA.c$83$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:83: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$kpdlcdtestPCA.c$85$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:85: IE |= 0x02;
	orl	_IE,#0x02
	C$kpdlcdtestPCA.c$86$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:86: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$kpdlcdtestPCA.c$87$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:87: EA = 1;
	setb	_EA
	C$kpdlcdtestPCA.c$88$1$127 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$kpdlcdtestPCA.c$90$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:90: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$kpdlcdtestPCA.c$92$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:92: PCA0MD = 0x81;      // SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$kpdlcdtestPCA.c$94$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:94: PCA0CN |= 0x40;     // enable PCA
	orl	_PCA0CN,#0x40
	C$kpdlcdtestPCA.c$95$1$129 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB0_Init$0$0 ==.
	C$kpdlcdtestPCA.c$97$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:97: void SMB0_Init(void)    // This was at the top, moved it here to call wait()
;	-----------------------------------------
;	 function SMB0_Init
;	-----------------------------------------
_SMB0_Init:
	C$kpdlcdtestPCA.c$99$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:99: SMB0CR = 0x93;      // Set SCL to 100KHz
	mov	_SMB0CR,#0x93
	C$kpdlcdtestPCA.c$100$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:100: ENSMB = 1;          // Enable SMBUS0
	setb	_ENSMB
	C$kpdlcdtestPCA.c$101$1$131 ==.
	XG$SMB0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$kpdlcdtestPCA.c$103$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:103: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$kpdlcdtestPCA.c$105$1$133 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:105: if (CF)
	C$kpdlcdtestPCA.c$107$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:107: CF = 0;                     // clear the interrupt flag
	jbc	_CF,00114$
	sjmp	00104$
00114$:
	C$kpdlcdtestPCA.c$108$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:108: nOverflows++;               // continuous overflow counter
	inc	_nOverflows
	clr	a
	cjne	a,_nOverflows,00115$
	inc	(_nOverflows + 1)
00115$:
	C$kpdlcdtestPCA.c$109$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:109: nCounts++;
	inc	_nCounts
	clr	a
	cjne	a,_nCounts,00116$
	inc	(_nCounts + 1)
00116$:
	C$kpdlcdtestPCA.c$110$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:110: PCA0L = PCA_START & 0xFF;   // low byte of start count
	mov	_PCA0L,#0x00
	C$kpdlcdtestPCA.c$111$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:111: PCA0H = PCA_START >> 8;     // high byte of start count
	mov	_PCA0H,#0x70
	C$kpdlcdtestPCA.c$112$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:112: if (nCounts > 50)
	clr	c
	mov	a,#0x32
	subb	a,_nCounts
	clr	a
	subb	a,(_nCounts + 1)
	jnc	00106$
	C$kpdlcdtestPCA.c$114$3$135 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:114: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$115$3$135 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:115: Counts++;               // seconds counter
	inc	_Counts
;	genFromRTrack removed	clr	a
	...
	sjmp	00106$
00104$:
	C$kpdlcdtestPCA.c$118$1$133 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:118: else PCA0CN &= 0xC0;           // clear all other 9-type interrupts
	anl	_PCA0CN,#0xc0
00106$:
	pop	psw
	pop	acc
	C$kpdlcdtestPCA.c$119$1$133 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$pause$0$0 ==.
	C$kpdlcdtestPCA.c$121$1$133 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:121: void pause(void)
;	-----------------------------------------
;	 function pause
;	-----------------------------------------
_pause:
	C$kpdlcdtestPCA.c$123$1$137 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:123: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$124$1$137 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:124: while (nCounts < 6);// 1 count -> (65536-PCA_START) x 12/22118400 = 20ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x06
...
;------------------------------------------------------------
	G$wait$0$0 ==.
	C$kpdlcdtestPCA.c$127$1$137 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:127: void wait(void)
;	-----------------------------------------
;	 function wait
;	-----------------------------------------
_wait:
	C$kpdlcdtestPCA.c$129$1$139 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:129: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$130$1$139 ==.
;	C:\Users\Tim\Documents\LITEC\Lab4\kpdlcdtestPCA.c:130: while (nCounts < 50);    // 50 counts -> 50 x 20ms = 1000ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x32
	...
	subb	a,#0x00
	jc	00101$
	C$kpdlcdtestPCA.c$131$1$139 ==.
	XG$wait$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
FkpdlcdtestPCA$__str_0$0$0 == .
___str_0:
	.db 0x0a
	.ascii "Type digits; end w/#"
	.db 0x00
FkpdlcdtestPCA$__str_1$0$0 == .
___str_1:
	.ascii "     %c%c%c%c%c"
	.db 0x00
FkpdlcdtestPCA$__str_2$0$0 == .
___str_2:
	.ascii "%c"
	.db 0x00
FkpdlcdtestPCA$__str_3$0$0 == .
___str_3:
	.db 0x0a
	.ascii "Start"
	.db 0x0d
...
___str_5:
	.db 0x0a
	.db 0x0d
	.ascii "Your key was: %c,  = Hex %X,  = Decimal %u"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
