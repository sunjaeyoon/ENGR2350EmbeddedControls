...
S:Lhw6.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:Lhw6.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$counts$0$0({2}SI:U),E,0,0
S:G$debounceCount$0$0({2}SI:U),E,0,0
S:G$PBcount$0$0({2}SI:U),E,0,0
S:G$PBonesec$0$0({2}SI:U),E,0,0
S:G$count_before$0$0({2}SI:U),E,0,0
S:G$count_after$0$0({2}SI:S),E,0,0
...
S:Fhw6$__str_0$0$0({39}DA39d,SC:S),D,0,0
S:Fhw6$__str_1$0$0({59}DA59d,SC:S),D,0,0
S:Fhw6$__str_2$0$0({26}DA26d,SC:S),D,0,0
S:Fhw6$__str_3$0$0({38}DA38d,SC:S),D,0,0
