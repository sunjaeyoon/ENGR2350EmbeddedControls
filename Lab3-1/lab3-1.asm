...
_aligned_alloc_PARM_2:
	.ds 2
Llab3_1.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
Llab3_1.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
Llab3_1.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
Llab3_1.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
Llab3_1.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
Llab3_1.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
Llab3_1.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
Llab3_1.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
Llab3_1.i2c_read_data$num_bytes$1$107==.
...
_Data::
	.ds 6
Llab3_1.ReadRanger$Data$1$136==.
_ReadRanger_Data_1_136:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	C$lab3_1.c$32$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:32: unsigned int PW_CENTER = 18432;
	mov	_PW_CENTER,#0x00
	mov	(_PW_CENTER + 1),#0x48
	C$lab3_1.c$33$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:33: unsigned int PW_MIN = 1844;
	mov	_PW_MIN,#0x34
	mov	(_PW_MIN + 1),#0x07
	C$lab3_1.c$34$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:34: unsigned int PW_MAX = 28420;//brightest //35020;//19ms pw
	mov	_PW_MAX,#0x04
	mov	(_PW_MAX + 1),#0x6f
	C$lab3_1.c$35$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:35: unsigned int PW = 18432;
	mov	_PW,#0x00
	mov	(_PW + 1),#0x48
	C$lab3_1.c$36$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:36: unsigned int PCA_start = 28672;   // start count for PCA
	mov	_PCA_start,#0x00
	mov	(_PCA_start + 1),#0x70
	C$lab3_1.c$37$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:37: unsigned char addr = 0xE0;
	mov	_addr,#0xe0
	C$lab3_1.c$43$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:43: unsigned char l_count = 0;
	mov	_l_count,#0x00
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab3_1.c$51$1$113 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:51: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab3_1.c$54$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:54: Sys_Init();
	lcall	_Sys_Init
	C$lab3_1.c$55$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:55: putchar(' '); //the quotes in this line may not format correctly
	mov	dpl,#0x20
	lcall	_putchar
	C$lab3_1.c$56$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:56: Port_Init();
	lcall	_Port_Init
	C$lab3_1.c$57$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:57: XBR0_Init();
	lcall	_XBR0_Init
	C$lab3_1.c$58$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:58: PCA_Init();
	lcall	_PCA_Init
	C$lab3_1.c$59$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:59: SMB_Init();
	lcall	_SMB_Init
	C$lab3_1.c$62$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:62: printf("Embedded Control Pulsewidth Calibration\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$lab3_1.c$66$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:66: PW = PW_CENTER;
	mov	_PW,_PW_CENTER
	mov	(_PW + 1),(_PW_CENTER + 1)
	C$lab3_1.c$73$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:73: while (1)
00104$:
	C$lab3_1.c$74$2$120 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:74: { if (new_light)
	mov	a,_new_light
	jz	00104$
	C$lab3_1.c$76$3$121 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:76: read = ReadRanger();//read the ranger
	lcall	_ReadRanger
	mov	_read,dpl
	mov	(_read + 1),dph
	C$lab3_1.c$79$3$121 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:79: Data[0] = 0x51; // write 0x51 to reg 0 of the ranger:
	mov	(_Data + 0),#0x51
	mov	(_Data + 1),#0x00
	C$lab3_1.c$80$3$121 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:80: i2c_write_data(addr, 0, Data, 1); // write one byte of data to reg 0 at addr
	...
	lcall	_i2c_write_data
	C$lab3_1.c$82$3$121 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:82: new_light = 0; //reset the 80ms flag
	mov	_new_light,#0x00
	C$lab3_1.c$83$3$121 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:83: printf("\r%d\n", read); //print the light
	push	_read
	push	(_read + 1)
	mov	a,#___str_4
	push	acc
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab3_1.c$95$1$119 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:95: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab3_1.c$97$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:97: P1MDOUT |= 0x08;  //set output pin for CEX0, CEX2, CEX3
	orl	_P1MDOUT,#0x08
	C$lab3_1.c$98$1$122 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$lab3_1.c$106$1$122 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:106: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$lab3_1.c$108$1$123 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:108: XBR0 = 0x27;  //configure crossbar as directed in the laboratory
	mov	_XBR0,#0x27
	C$lab3_1.c$109$1$123 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$lab3_1.c$117$1$123 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:117: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$lab3_1.c$121$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:121: PCA0MD = 0x81; // SYSCLK/12
	mov	_PCA0MD,#0x81
	C$lab3_1.c$122$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:122: PCA0CN = 0x40; //enable PCA0 counter
	mov	_PCA0CN,#0x40
	C$lab3_1.c$123$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:123: EIE1 |= 0x08;  //enable PCA interrupt
	orl	_EIE1,#0x08
	C$lab3_1.c$124$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:124: EA = 1;        //enable GLobal Interrupt
	setb	_EA
	C$lab3_1.c$126$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:126: PCA0CPM3 = 0xC2;
	mov	_PCA0CPM3,#0xc2
	C$lab3_1.c$128$1$125 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$lab3_1.c$136$1$125 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:136: void SMB_Init(void)
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$lab3_1.c$138$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:138: ENSMB = 1; //enable SMB
	setb	_ENSMB
	C$lab3_1.c$139$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:139: SMB0CR = 0x93; //Set clock
	mov	_SMB0CR,#0x93
	C$lab3_1.c$140$1$127 ==.
	XG$SMB_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$lab3_1.c$148$1$127 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:148: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	...
	push	psw
	mov	psw,#0x00
	C$lab3_1.c$153$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:153: PCA0 = 65535 - PCA_start;       // start count for 20ms
	mov	r4,_PCA_start
	mov	r5,(_PCA_start + 1)
	clr	a
	mov	r6,a
	...
	mov	((_PCA0 >> 0) & 0xFF),r4
	mov	((_PCA0 >> 8) & 0xFF),r5
	C$lab3_1.c$156$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:156: CF = 0;                 // Very important - clear interrupt flag
	clr	_CF
	C$lab3_1.c$159$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:159: l_count++;
	inc	_l_count
	C$lab3_1.c$161$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:161: if(l_count>4)
	mov	a,_l_count
	add	a,#0xff - 0x04
	jnc	00103$
	C$lab3_1.c$163$2$130 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:163: new_light = 1; // at least 4 overflows is about 80 ms
	mov	_new_light,#0x01
	C$lab3_1.c$164$2$130 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:164: l_count = 0;
	mov	_l_count,#0x00
00103$:
	pop	psw
	pop	ar4
...
;------------------------------------------------------------
	...
	C$lab3_1.c$169$1$129 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:169: void Set_Pulsewidth()
;	-----------------------------------------
;	 function Set_Pulsewidth
;	-----------------------------------------
_Set_Pulsewidth:
	C$lab3_1.c$173$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:173: input = getchar();
	lcall	_getchar
	mov	r7,dpl
	C$lab3_1.c$174$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:174: if(input == 'd')  // single character input to increase the pulsewidth
	cjne	r7,#0x64,00108$
	C$lab3_1.c$176$2$132 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:176: PW += 200;
	mov	a,#0xc8
	add	a,_PW
	mov	_PW,a
	clr	a
	addc	a,(_PW + 1)
	mov	(_PW + 1),a
	C$lab3_1.c$178$2$132 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:178: if(PW > PW_MAX)  // check if greater than pulsewidth maximum
	clr	c
	mov	a,_PW_MAX
	subb	a,_PW
	mov	a,(_PW_MAX + 1)
	subb	a,(_PW + 1)
	jnc	00109$
	C$lab3_1.c$180$3$133 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:180: PW = PW_MAX;    // set PW to the maximum value
	mov	_PW,_PW_MAX
	mov	(_PW + 1),(_PW_MAX + 1)
	sjmp	00109$
00108$:
	C$lab3_1.c$183$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:183: else if(input == 'b')  // single character input to decrease the pulsewidth
	cjne	r7,#0x62,00109$
	C$lab3_1.c$185$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:185: PW -= 200;
	mov	a,_PW
	add	a,#0x38
	mov	_PW,a
	mov	a,(_PW + 1)
	addc	a,#0xff
	mov	(_PW + 1),a
	C$lab3_1.c$187$2$134 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:187: if(PW < PW_MIN)
	clr	c
	mov	a,_PW
	subb	a,_PW_MIN
	mov	a,(_PW + 1)
	subb	a,(_PW_MIN + 1)
	jnc	00109$
	C$lab3_1.c$189$3$135 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:189: PW = PW_MIN;     // set PW to the minimum value
	mov	_PW,_PW_MIN
	mov	(_PW + 1),(_PW_MIN + 1)
00109$:
	C$lab3_1.c$193$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:193: printf("\rPW: %u\n", PW);
	push	_PW
	push	(_PW + 1)
	mov	a,#___str_5
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
	C$lab3_1.c$194$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:194: PCA0CP3 = 0xFFFF - PW;
	mov	a,#0xff
	clr	c
	subb	a,_PW
	...
	C$lab3_1.c$196$1$131 ==.
	XG$Set_Pulsewidth$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ReadRanger'
;------------------------------------------------------------
;Data                      Allocated with name '_ReadRanger_Data_1_136'
;light                     Allocated to registers r6 r7 
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$lab3_1.c$198$1$131 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:198: unsigned int ReadRanger()
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$lab3_1.c$202$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:202: i2c_read_data(addr, 1, Data, 1); // read one byte, starting at reg 1
	mov	_i2c_read_data_PARM_3,#_ReadRanger_Data_1_136
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x01
	mov	_i2c_read_data_PARM_4,#0x01
	mov	dpl,_addr
	lcall	_i2c_read_data
	C$lab3_1.c$203$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:203: light = Data[0];
	mov	r6,_ReadRanger_Data_1_136
	mov	r7,#0x00
	C$lab3_1.c$204$1$136 ==.
;	C:\Users\Tim\Documents\LITEC\Lab3-1\lab3-1.c:204: return light;
	mov	dpl,r6
	mov	dph,r7
	C$lab3_1.c$205$1$136 ==.
	XG$ReadRanger$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
