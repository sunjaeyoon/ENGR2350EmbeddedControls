...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw5_Timothy_Ho.c$36$1$12 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:36: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw5_Timothy_Ho.c$38$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:38: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw5_Timothy_Ho.c$39$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:39: putchar(' ');    
	mov	dpl,#0x20
	lcall	_putchar
	C$hw5_Timothy_Ho.c$40$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:40: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw5_Timothy_Ho.c$41$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:41: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw5_Timothy_Ho.c$43$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:43: while (1) /* the following loop waits until a key is pressed on the
00108$:
	C$hw5_Timothy_Ho.c$47$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:47: printf("\rHit any key on the keyboard to start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$hw5_Timothy_Ho.c$48$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:48: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw5_Timothy_Ho.c$52$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:52: count = 0; //reset the counter
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$hw5_Timothy_Ho.c$53$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:53: TMR0 = 0; //Clears the high and low byte of counter same as TL0 = 0; TH0 = 0;
	mov	((_TMR0 >> 0) & 0xFF),a
	mov	((_TMR0 >> 8) & 0xFF),a
	C$hw5_Timothy_Ho.c$54$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:54: TR0 = 1; //Timer 1 enabled
	setb	_TR0
	C$hw5_Timothy_Ho.c$57$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:57: while (count < 18000);
00101$:
	clr	c
	mov	a,_count
	subb	a,#0x50
	...
	subb	a,#0x46
	jc	00101$
	C$hw5_Timothy_Ho.c$58$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:58: printf("2.5 seconds have passed. \r\n");  	//print that the time has elapsed
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$hw5_Timothy_Ho.c$60$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:60: printf("overflows print statement here: %d\n", count);	// print number of overflows using count variable
	push	_count
	push	(_count + 1)
	mov	a,#___str_2
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
	C$hw5_Timothy_Ho.c$63$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:63: count = 0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$hw5_Timothy_Ho.c$64$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:64: while (count < 7200);
00104$:
	clr	c
	mov	a,_count
	subb	a,#0x20
	...
	subb	a,#0x1c
	jc	00104$
	C$hw5_Timothy_Ho.c$65$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:65: printf("\r1 seconds have passed. \r\n");  	//print that the time has elapsed
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$hw5_Timothy_Ho.c$67$2$32 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:67: printf("overflows print statement here: %d\n", count);	// print number of overflows using count variable
	push	_count
	push	(_count + 1)
	mov	a,#___str_2
	push	acc
...
;------------------------------------------------------------
	...
	C$hw5_Timothy_Ho.c$74$1$31 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:74: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw5_Timothy_Ho.c$78$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:78: IE |= 0x82;       // enable global interrupts using bit masking
	orl	_IE,#0x82
	C$hw5_Timothy_Ho.c$79$1$34 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw5_Timothy_Ho.c$81$1$34 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:81: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw5_Timothy_Ho.c$84$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:84: CKCON &= 0xF7;   // Timer0 uses SYSCLK/12
	anl	_CKCON,#0xf7
	C$hw5_Timothy_Ho.c$85$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:85: TMOD &= 0xF0;    // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$hw5_Timothy_Ho.c$86$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:86: TMOD |= 0x02;    // Timer0 mode setting (Set timer0 to mode 1 8bit)
	orl	_TMOD,#0x02
	C$hw5_Timothy_Ho.c$87$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:87: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw5_Timothy_Ho.c$88$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:88: TL0 = 0;         // Clear low byte of register T0 (line 88 and 89 can be written as 1 line TMR0 = 0)
	mov	_TL0,#0x00
	C$hw5_Timothy_Ho.c$89$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:89: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw5_Timothy_Ho.c$91$1$36 ==.
	XG$Timer_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw5_Timothy_Ho.c$95$1$36 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:95: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	push	acc
	push	psw
	C$hw5_Timothy_Ho.c$99$1$38 ==.
;	C:\Users\Tim\Documents\LITEC\hw5\hw5_Timothy_Ho.c:99: count++; //adds one to every overflow
	inc	_count
	clr	a
	cjne	a,_count,00103$
	inc	(_count + 1)
...
;	eliminated unneeded push/pop b
	.area CSEG    (CODE)
	.area CONST   (CODE)
Fhw5_Timothy_Ho$__str_0$0$0 == .
___str_0:
	.db 0x0d
	.ascii "Hit any key on the keyboard to start "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw5_Timothy_Ho$__str_1$0$0 == .
___str_1:
	.ascii "2.5 seconds have passed. "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw5_Timothy_Ho$__str_2$0$0 == .
___str_2:
	.ascii "overflows print statement here: %d"
	.db 0x0a
	.db 0x00
Fhw5_Timothy_Ho$__str_3$0$0 == .
___str_3:
	.db 0x0d
	.ascii "1 seconds have passed. "
	.db 0x0d
	.db 0x0a
	.db 0x00
	.area XINIT   (CODE)
